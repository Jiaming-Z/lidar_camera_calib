...
# lidar_path = "lidar_points.pkl"
# pic2_path = "image_undistorted.png"
threshold         = 10 # number of pointclouds to accumulate
collection_period = 0.2  # seconds
output_path = os.path.join(os.getcwd(), str(threshold) + "_pdc_calib_data.pkl") # If you change this, also change the one in calibration.py
...
with open(os.path.join(os.getcwd(), ), 'rb') as file:
