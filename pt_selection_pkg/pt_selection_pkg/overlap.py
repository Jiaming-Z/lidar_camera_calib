...
class overlap_pub_node(Node):
    ...
    def __init__(self):
        ...
        # input this parameter: undistorted camera matrix K written in undistorted_camera_matrix.txt from last step 
        self.undistorted_camera_info = np.array([[1.57700e+03,0.00000e+00,5.36020e+02],
 [0.00000e+00,1.58130e+03,3.20674e+02],
 [0.00000e+00,0.00000e+00,1.00000e+00]])
        
        # input this parameter: rotation matrix got from the calibration
 ...
 [ 9.98533e-01,-2.54847e-02, 4.77771e-02]])
        ...
        # input this parameter: translation vector got from the calibration
        self.t = np.array([-0.12104,-0.05424,-0.22951])

        # input this parameter: list of all selected points written in R_t.txt from the calibration
    ...
    def publisher_overlay_callback(self):
        ...
        for i in range(len(self.sel_img)):
            ...
            cv2.circle(im_undistorted_cv, im_pt, 2, (0, 255, 0), 2)
            cv2.circle(im_undistorted_cv, pc_pt, 2, (255, 0, 0), 2)
